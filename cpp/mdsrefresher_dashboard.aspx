<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="mdsrefresher_dashboard.aspx.cs" Inherits="TomTom_Info_Page.cpp.mdsrefresher_dashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <br /><asp:Label ID="Label4" runat="server" Text="MDS Refresher Dashboard (old)" Font-Size="Larger" Font-Bold="True"></asp:Label><br /><hr />
    <br />
    <asp:Button ID="btnRefresh" runat="server" Text="Refresh" OnClick="btnRefresh_Click" Width="80px" />
&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://infopage-lodz.ttg.global/cpp/mdsrefresher_machines.aspx" Target="_blank">View machines</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnViewgroupid" runat="server" OnClick="btnViewgroupid_Click" Text="View details for group ids" Width="164px" />
    <asp:TextBox ID="txtgroupids" runat="server" Width="481px" ToolTip="provide comma delimted group_id"></asp:TextBox>
    &nbsp;&nbsp; comma separated groupids<br /><br />
    ...
    <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" Visible="False">
        ...
        <asp:ListItem Value="1" Selected="True">Only running</asp:ListItem>
    </asp:DropDownList>
    </strong>
