...
{
    public partial class gradient_dashboard : System.Web.UI.Page
    {
        ...
        protected void ImportCSV()
        {
            ...
            var inputDirectory = new DirectoryInfo(@"\\ams3-svm-maps-cifs01.ttg.global\sppproc\tifdata\TSD\Gradient\dashboard");
            var myFile = inputDirectory.GetFiles().OrderByDescending(f => f.CreationTimeUtc).First();
            string dst_path = myFile.FullName;

            HyperLink1.NavigateUrl = "http://jenkins-adp-lodz.tomtomgroup.com:8080/view/Dashboards/job/GradientDashboard/ws/" + myFile.Name;
            HyperLink1.Text = myFile.Name ;
            
            Label5.Text = myFile.Name.Substring(18,13);
