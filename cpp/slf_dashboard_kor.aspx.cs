...
{
    public partial class slf_dashboard_kor : System.Web.UI.Page
    {
        ...
        protected void fill_grid()
        {
            ...
            query = "select * from transaction_db.v_slfdashboard" + arg1;
            queryDataset = "select distinct dataset from transaction_db.transactions order by 1";
            NpgsqlConnection conn = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["speedlimitfusionkorea"].ConnectionString);
