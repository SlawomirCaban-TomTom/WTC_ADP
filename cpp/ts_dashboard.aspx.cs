...
{
    public partial class ts_dashboard : System.Web.UI.Page
    {
        ...
        protected void fill_grid()
        {
            ...
            query = "select * from transactions.ts_dashboard_aws" + arg1 + " order by 3 desc";
            queryDataset = "select distinct dataset from transactions.transaction_metadata order by 1";
